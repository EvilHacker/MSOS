...
// This class maintain a fixed sized queue of <Element>s.
...
{
	return basicAddLast(item, timeout);
}
...
{
	return basicRemoveReservedElementFirst();
}
...
{
	return basicRemoveReservedElementLast();
}
